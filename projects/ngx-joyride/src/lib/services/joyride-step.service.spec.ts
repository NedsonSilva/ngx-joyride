...
describe('JoyrideStepService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [
                ...
                {
                    provide: JoyrideBackdropService,
                    useClass: JoyrideBackdropServiceFake
                },
                {
    ...
    beforeEach(() => {
        ...
        optionsService.getWaitingTime.and.returnValue(
            DEFAULT_TIMEOUT_BETWEEN_STEPS
        );
    });
    ...
    describe('when eventListener.scrollEvent publish', () => {
        it("should call backdropService.redraw with the right 'scroll' parameter", fakeAsync(() => {
            ...
            expect(backdropService.redraw).toHaveBeenCalledWith(
                jasmine.objectContaining(STEP0),
                240
            );
        }));
    ...
    describe('close()', () => {
        ...
        it('should remove the step calling stepDrawerService.remove', () => {
            expect(stepDrawerService.remove).toHaveBeenCalledTimes(
                DEFAULT_TIMEOUT_BETWEEN_STEPS
            );
        ...
        it('should call eventListener.stopListeningResizeEvents', () => {
            ...
            ).toHaveBeenCalledTimes(DEFAULT_TIMEOUT_BETWEEN_STEPS);
        });
    });
    ...
    describe('startTour()', () => {
        ...
        it('should call stepsContainerService.get with StepActionType.NEXT', () => {
            expect(stepsContainerService.get).toHaveBeenCalledWith(
                StepActionType.NEXT
            );
        });
    ...
    describe('next', () => {
        ...
        it('should call stepsContainerService.get with StepActionType.NEXT twice', () => {
            expect(stepsContainerService.get.calls.argsFor(0)).toEqual([
                StepActionType.NEXT
            ]);
            expect(stepsContainerService.get.calls.argsFor(1)).toEqual([
                StepActionType.NEXT
            ]);
        });
        ...
        it('should call backDropService.draw', () => {
            expect(backdropService.draw).toHaveBeenCalledTimes(
                DEFAULT_TIMEOUT_BETWEEN_STEPS
            );
